...
#include <stdlib.h>
#include <time.h>
//Allocator of dynamic syze cards array with
//autofee after going out of scope
...
//the general container with circukar buffer
...
//Cheks for succeeding rank without to use
//as a component for variuos kinds of
//validation of legal moves over different games
#define NEXT_RANK(a,b) (((a) - (b)) == 1)
//Checks for preceding rank, as the above
//is intended for component of validation
//functions or macros
#define PREVIOUS_RANK(a,b) (((b) - (a)) == 1)
...
#define SAME_COLOR(a,b) (IS_RED_SUIT((a).s)*IS_RED_SUIT((b).s) || IS_BLACK_SUIT((a).s)*IS_BLACK_SUIT((b).s))
...
// of cards (stacked cards regardles
// of where you will draw from top
// or bottom), it is intendend to be
...
// cards it works the same as clasic
...
// previous order and yiur last operation
